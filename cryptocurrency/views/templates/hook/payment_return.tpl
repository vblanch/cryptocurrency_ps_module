...
<p>{l s='Your order on %s is complete.' sprintf=$shop_name mod='cryptocurrency'}
		...
		<br /><br />- {l s='Name of account owner' mod='cryptocurrency'}  <strong>{if $cryptocurrencyOwner}{$cryptocurrencyOwner}{else}___________{/if}</strong>
		...
		<br /><br />- {l s='Cryptocurrency address' mod='cryptocurrency'}  <strong>{if $cryptocurrencyAddress}{$cryptocurrencyAddress}{else}___________{/if}</strong>
		{if !isset($reference)}
